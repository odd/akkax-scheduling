...
object SchedulerSpec {
  val testConfRevolver = ConfigFactory.parseString("""
    akka.persistence.scheduler.implementation = akka.contrib.DefaultPersistentScheduler
  """)
}

trait SchedulerSpec extends BeforeAndAfterEach with DefaultTimeout with ImplicitSender {
